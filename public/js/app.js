...
__webpack_require__(/*! ./counter/counter */ "./resources/js/counter/counter.js");
__webpack_require__(/*! ./slider */ "./resources/js/slider.js");
__webpack_require__(/*! ./product/shares */ "./resources/js/product/shares.js");
__webpack_require__(/*! ./product/shareLink */ "./resources/js/product/shareLink.js");
...
document.querySelector('.counter').addEventListener('click', function (e) {
  return counterProduct(e.target, counterInput);
});
counterInput.addEventListener('input', function (e) {
  return changeCounterInput(e.target);
});
counterInput.addEventListener('change', function (event) {
...
/***/ "./resources/js/product/shareLink.js":
/*!*******************************************!*\
  !*** ./resources/js/product/shareLink.js ***!
  \*******************************************/
/*! exports provided: shareIcons */
...
/***/ "./resources/js/product/shares.js":
/*!****************************************!*\
  !*** ./resources/js/product/shares.js ***!
  \****************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _shareLink_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./shareLink.js */ "./resources/js/product/shareLink.js");

function setShareProduct() {
  var shares = ['vk', 'google', 'facebook', 'twitter'];
  var shareBlock = document.querySelector('.share');
  shares.forEach(function (shareItem) {
    var shareLink = document.createElement('a');
    shareLink.href = _shareLink_js__WEBPACK_IMPORTED_MODULE_0__["shareIcons"][shareItem].link;
    shareLink.classList.add('share__link');
    shareLink.innerHTML = "<svg xmlns=\"http://www.w3.org/2000/svg\"  viewBox=\"0 0 50 50\" width=\"15px\" height=\"15px\">".concat(_shareLink_js__WEBPACK_IMPORTED_MODULE_0__["shareIcons"][shareItem].path, "</svg>");
    shareBlock.appendChild(shareLink);
  });
  var shareCount = document.createElement('div');
...
function setActivePreview(event) {
  if (event.target.getAttribute('src')) {
    ...
    var beforeItemSlide = document.querySelector('.slider__item--active');
...
__webpack_require__(/*! C:\ospanel\domains\i20\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\ospanel\domains\i20\resources\sass\app.scss */"./resources/sass/app.scss");
